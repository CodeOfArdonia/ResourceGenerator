...
public final class ResGenSuggestions {
    ...
    public static final SuggestionProvider<ServerCommandSource> LOOT_TABLE = SuggestionProviders.register(Identifier.of(ResourceGenerator.MOD_ID, "loot_table"), (context, builder) -> context.getSource() instanceof ServerCommandSource source ? CommandSource.suggestIdentifiers(source.getServer().getLootManager().getIds(LootDataType.LOOT_TABLES), builder) : context.getSource().getCompletions(context));
}
